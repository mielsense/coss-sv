    ...
    <div class="fixture">
      ...
      <section data-particle="p-toast-3">
        <Button
          ...
          variant="outline">Loading Toast</Button
        >
      </section>
      ...
      <section data-particle="p-toast-10">
        <Button
          ...
          variant="outline">One Success Toast</Button
        >
      </section>
...
{#snippet checkIcon(className?: string)}
  <FixtureIcon aria-hidden="true" class={className} name="check" />
{/snippet}
{#snippet copyIcon(className?: string)}
  <FixtureIcon aria-hidden="true" class={className} name="copy" />
{/snippet}
{#snippet downloadIcon()}
  <FixtureIcon aria-hidden="true" name="download" />
{/snippet}
{#snippet saveIcon()}
  <FixtureIcon aria-hidden="true" name="save" />
{/snippet}
