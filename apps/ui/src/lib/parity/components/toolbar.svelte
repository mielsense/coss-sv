...
{#snippet lineIcon(name: FixtureIconName)}
  <FixtureIcon aria-hidden="true" {name} />
{/snippet}
{#snippet chevronsIcon()}
  <FixtureIcon aria-hidden="true" class="-me-1 size-4.5 opacity-80 sm:size-4" name="unfold-more" />
{/snippet}
{#snippet checkIcon()}
          ...
          <Tooltip.Root bind:open={tooltipOpen.left}>
            ...
            >
              <ToggleGroup.Item
                ...
                bind:ref={leftAnchor}
                value="left">{@render lineIcon("align-left")}</ToggleGroup.Item
              >
            </Tooltip.Trigger>
          ...
          <Tooltip.Root bind:open={tooltipOpen.center}>
            ...
            >
              <ToggleGroup.Item
                ...
                value="center">{@render lineIcon("align-center")}</ToggleGroup.Item
              >
            </Tooltip.Trigger>
            <Tooltip.Popup
              anchor={centerAnchor ?? undefined}
              id="toolbar-tooltip-center"
              sideOffset={8}>Align center</Tooltip.Popup
            >
          </Tooltip.Root>
          <Tooltip.Root bind:open={tooltipOpen.right}>
            ...
            >
              <ToggleGroup.Item
                ...
                value="right">{@render lineIcon("align-right")}</ToggleGroup.Item
              >
            </Tooltip.Trigger>
            <Tooltip.Popup
              anchor={rightAnchor ?? undefined}
              id="toolbar-tooltip-right"
              sideOffset={8}>Align right</Tooltip.Popup
            >
          </Tooltip.Root>
        </ToggleGroup.Root>
        <Toolbar.Separator />
          ...
          <Tooltip.Root bind:open={tooltipOpen.currency}>
            ...
            >
              <Toolbar.Button
                ...
                class={iconButton}>{@render lineIcon("currency")}</Toolbar.Button
              >
            </Tooltip.Trigger>
            <Tooltip.Popup
              anchor={currencyAnchor ?? undefined}
              id="toolbar-tooltip-currency"
              sideOffset={8}>Format as currency</Tooltip.Popup
            >
          </Tooltip.Root>
          <Tooltip.Root bind:open={tooltipOpen.percent}>
            ...
            >
              <Toolbar.Button
                ...
                class={iconButton}>{@render lineIcon("percent")}</Toolbar.Button
              >
            </Tooltip.Trigger>
            <Tooltip.Popup
              anchor={percentAnchor ?? undefined}
              id="toolbar-tooltip-percent"
              sideOffset={8}>Format as percent</Tooltip.Popup
            >
          </Tooltip.Root>
        </Toolbar.Group>
        <Toolbar.Separator />
          ...
          <SelectPrimitive.Root bind:open={fontOpen} bind:value={font} items={fonts}>
            <Tooltip.Root bind:open={tooltipOpen.font}>
              ...
              <Tooltip.Popup
                ...
                sideOffset={8}>Select a different font</Tooltip.Popup
              >
            </Tooltip.Root>
