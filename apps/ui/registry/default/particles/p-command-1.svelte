      ...
      ><Command.Input placeholder="Search for apps and commands..." /><Command.Panel
        ><Command.Empty>No results found.</Command.Empty><Command.List>
          {#each groups as group (group.value)}<Command.Group items={group.items}
              ...
              ></Command.Group
            ><Command.Separator />{/each}
        </Command.List></Command.Panel
      ><Command.Footer
        ><div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            <KbdGroup
              ><Kbd><HugeiconsIcon aria-hidden="true" icon={ArrowUp01Icon} strokeWidth={2} /></Kbd
              ><Kbd><HugeiconsIcon aria-hidden="true" icon={ArrowDown01Icon} strokeWidth={2} /></Kbd
              ></KbdGroup
            ><span>Navigate</span>
          </div>
          <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-2"><Kbd>Esc</Kbd><span>Close</span></div></Command.Footer
      ></Command.Root
    ></Command.DialogPopup
  >
</Command.DialogRoot>
