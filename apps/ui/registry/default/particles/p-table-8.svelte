<script module lang="ts">
  ...
  export const meta = defineParticleMeta({
    components: ["badge", "button", "card", "checkbox", "pagination", "select", "table"],
    containerClass: "**:data-[slot=preview]:w-full sm:**:data-[slot=preview]:max-w-4xl",
    id: "p-table-8",
    interactive: true,
    responsive: true,
    title: "Flights card data table",
    colSpan: 2,
  });
</script>
...
<script lang="ts">
  ...
  import { Badge, Checkbox, cn, Pagination, Select, Table } from "@coss-sv/ui";
  type Flight = {
    id: string;
    flightCode: string;
    destination: string;
...
<Card.Frame class="w-full">
  ...
  </Table.Root><Card.FrameFooter class="p-2">
